...
ggplot(mapping = aes(x=nyc_ridership$trip_day)) +
  geom_line(mapping = aes(y=nyc_ridership$trip_count), color = "blue", alpha=0.3) +
  geom_smooth(mapping = aes(y=nyc_ridership$trip_count), method="loess", color = "blue", span = 0.1) +
  geom_line(mapping=aes(y=fitted), color = "red", alpha = 0.3) +
  geom_smooth(mapping = aes(y=fitted), method="loess", color = "red", span = 0.1) +
